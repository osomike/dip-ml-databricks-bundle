...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``dip_ml_usecase_01/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in dip-ml-usecase-01/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in dip-ml-usecase-01/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-dip-ml-usecase-01-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-dip-ml-usecase-01-model", "Model Name")
