...
git add README.md docs .gitignore dip_ml_usecase_01/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-1762224908719813.13.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-1235588649545666.6.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[dip-ml-usecase-01/databricks.yml](../dip_ml_usecase_01/databricks.yml) file.
...
Follow the instructions in [dip-ml-usecase-01/resources/README.md](../dip_ml_usecase_01/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../dip_ml_usecase_01/resources/README.md)  to propose, test, and deploy
