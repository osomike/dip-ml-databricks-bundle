...
Opening a pull request will trigger a[workflow](../.github/workflows/dip-ml-usecase-01-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-1762224908719813.13.azuredatabricks.net/ml/models/staging-dip-ml-usecase-01-model)
* [Prod workspace registered model](https://adb-1235588649545666.6.azuredatabricks.net/ml/models/prod-dip-ml-usecase-01-model). 
